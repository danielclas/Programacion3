...
class UsuariosController {
    ...
    public function registro(Request $request, Response $response, $args){
        ...
        if(isset($params) && self::validateRegistro($params)){
            try{
                ...
                $user->clave = Authenticator::encryptPassword($params["clave"]);
                $user->save();
    ...
    public function login(Request $request, Response $response, $args){
        ...
        if(isset($params) && self::validateLogin($params)){
            ...
            $success = true;
            $data = Authenticator::createToken($temp, $params['clave']);
        }
    ...
    private static function validateRegistro($params){
        ...
        if(!RequestValidator::containsParams($params, ['email', 'clave', 'tipo', 'usuario'])){
            $valid = false;
        }else{
